...
type ProductUsecaseItf interface {
	...
	UpdateProduct(productId uuid.UUID, req dto.UpdateProductRequest) *res.Err
}
...
func (u ProductUsecase) UpdateProduct(productId uuid.UUID, req dto.UpdateProductRequest) *res.Err {
