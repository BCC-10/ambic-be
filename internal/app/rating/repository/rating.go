...
type RatingMySQLItf interface {
	Get(rating *[]entity.Rating, param dto.RatingParam) error
...
func (r *RatingMySQL) Get(rating *[]entity.Rating, param dto.RatingParam) error {
	return r.db.Debug().Find(rating, param).Error
}
